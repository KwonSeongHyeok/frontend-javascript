...
function 옵션선택(선택한옵션) {
    ...
    if(다음질문div) {
        현재질문div.style.display = "none"; // 현재질문 숨기기
...
function 결과확인하기(){
    ...
    for(let 문제 in 정답) { // 반복적인 작업을 수행하는 for 문
        ...
        // 첫번째 반복
        // 문제 = 문제 1
        // 정답[문제] = 정답[문제1] = E 인지 / 정답[문제1] = 정답[문제1] = I
        // let MBTI갯수확인 = {'E':1, 'I':0, 'S':0, 'N':0, 'T':0, 'F':0, 'J':0, 'P':0};

        // 문제 = 문제 2
        // 정답[문제] = 정답[문제2] = S 인지 / 정답[문제1] = 정답[문제1] = N
        // let MBTI갯수확인 = {'E':1, 'I':0, 'S':0, 'N':1, 'T':0, 'F':0, 'J':0, 'P':0};

        // 문제 = 문제 3
        // 정답[문제] = 정답[문제3] = T 인지 / 정답[문제1] = 정답[문제1] = F
        // let MBTI갯수확인 = {'E':1, 'I':0, 'S':0, 'N':1, 'T':1, 'F':0, 'J':0, 'P':0};

        // 문제 = 문제 4
        // 정답[문제] = 정답[문제4] = J 인지 / 정답[문제1] = 정답[문제1] = P
        // let MBTI갯수확인 = {'E':1, 'I':0, 'S':0, 'N':1, 'T':0, 'F':0, 'J':0, 'P':1};
    }
    // MBTI 결과 계산
